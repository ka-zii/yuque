 ...
 * @param <T> 出参类型
 */
public abstract class AbstractRequestParametersData<P, T>  extends AbstractRequestData<T>{
     ...
     * @param val 值
     * @return {@link AbstractRequestParametersData}
     */
    public AbstractRequestParametersData<P, T> parameter(SFunction<P, ?> key, Object val) {
     ...
     * @return {@link AbstractRequestParametersData}
     */
    public AbstractRequestParametersData<P, T> parameter(String key, Object val) {
